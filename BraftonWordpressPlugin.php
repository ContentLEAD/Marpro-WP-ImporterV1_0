...
function logMsg($msg)
{
	...
	//echo $logLoc;
	file_put_contents($logLoc, $msg, FILE_APPEND);
...
?>
		...
		<br><br>
								...
								<option value="dev.api.brafton.com" <?php
		if ($domain == 'dev.api.brafton.com')
			echo 'SELECTED';
?>>Dev Brafton</option>
<option value="dev.api.contentlead.com" <?php
		if ($domain == 'dev.api.contentlead.com')
			echo 'SELECTED';
?>>Dev Contentlead</option>
...
?>>ContentLEAD</option>
		...
		if ($domain == 'api.castleford.com.au')
			echo 'SELECTED';
?>>Castleford</option>
<option value="test.api.brafton.com" <?php
		if ($domain == 'test.api.brafton.com')
			echo 'SELECTED';
?>>Staging Brafton</option>
...
function braftonxml_sched_load_articles($url, $API_Key)
{
	...
	foreach ($articles as $a)
	{
		...
		//$post_content_log = $a->getText();
		//$post_content_log = $post_content;
		//$post_content_log = $article['post_content'];
		//$post_content_log = substr($post_content_log, -525);

		
		//logMsg($post_content_log);
